...
export default function Hero({ id }) {
  return (
    <div id={id} className="pt-32 px-12 md:py-80  md:flex text-xl justify-between md:justify-start md:items-center w-screen h-screen bg-hero1 bg-cover bg-center ">
